<?php
class Teorema_Integration_Block_Adminhtml_Modifiedtables_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
	   public function __construct()
    {

      echo "Construct Teorema_Integration_Block_Adminhtml_Modifiedtables_Edit ";
      die();
